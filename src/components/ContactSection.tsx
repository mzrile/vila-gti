  ...
  return (
    <section id="kontakt" className="section-padding bg-secondary text-secondary-foreground" ref={ref}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <p className="text-gold-light tracking-[0.3em] uppercase text-sm mb-3 font-body">{c.label}</p>
          <h2 className="font-display text-3xl md:text-5xl font-bold mb-6">
            {c.title1} <span className="text-gold-gradient italic">{c.title2}</span>
          </h2>
        ...
        >
          <p className="text-secondary-foreground/50 font-body text-sm mb-1">{c.address}</p>
          <p className="text-secondary-foreground/50 font-body text-sm mb-8">{c.phone}</p>
