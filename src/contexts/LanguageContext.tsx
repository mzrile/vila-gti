...
const translations = {
  ...
  about: {
    ...
    en: {
      label: "About",
      title1: "Event house rental,",
      title2: "Party house",
      title3: "with pool",
      desc: "Villa GTI is located in the peaceful surroundings of Dubrava, at Ivanovićeva 47b, Zagreb. Party house Zagreb — ideal for birthdays, bachelor & bachelorette parties, team building, and weekend getaways for up to 15 guests.",
