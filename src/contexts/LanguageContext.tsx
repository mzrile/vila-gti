...
const translations = {
  ...
  hero: {
    hr: {
      ...
      title1: "Savršeno mjesto za",
      title2: "odmor i proslave",
      desc: "Privatna vila s bazenom i saunom za do 15 osoba. Idealno za rođendane, djevojačke večeri, team building i opuštajući vikend.",
    ...
    en: {
      ...
      title1: "The perfect place for",
      title2: "vacation & celebrations",
      desc: "Private villa with pool and sauna for up to 15 guests. Ideal for birthdays, bachelorette parties, team building, and relaxing weekends.",
      cta: "Book your stay",
      gallery: "Our photos",
      more: "Learn more",
    },
